...
import { selectAllShows, selectSearchResults, selectIsLoading, selectFavorites } from '../../store/movies.selectors';
    ...
    <div class="home-container">
      <div class="search-header">
        ...
        <mat-form-field appearance="outline" class="search-field">
          ...
          <input matInput [(ngModel)]="searchQuery" (ngModelChange)="onSearchChange($event)" placeholder="Type to search...">
      ...
      <div class="no-results" *ngIf="!(loading$ | async) && (displayedMovies$ | async)?.length === 0">
